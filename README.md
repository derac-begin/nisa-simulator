...
**Concept:** "The Automation Initiative" Strategy (Powered by marimo v0.23.1)

---

## 📱 Application List (Live Demos)

ブラウザ上で Python が動作するため、インストール不要で即座に使用可能です。情報漏洩リスク0%の完全オフライン処理を実現しています。

| App Name | Description | Status |
| :--- | :--- | :--- |
| **[📈 積立NISAシミュレーター](https://derac-begin.github.io/nisa-simulator/nisa_calc_v0.19.0.html)** | `nisa_calc_v0.19.0.html`<br>積立投資の複利効果を可視化するシミュレーター。 | 🟢 Live |
...
| **[🛡️ Secure QR Batch Maker (QRコード一括生成くん)](https://derac-begin.github.io/nisa-simulator/secure_qr_batch.html)** | `secure_qr_batch.html`<br>CSVファイルを読み込み、複数のQRコードを瞬時に一括生成してZIPファイルとしてダウンロードできるユーティリティアプリ。 | 🟢 Live |
...
- **Core Framework:** [marimo](https://marimo.io/) (v0.23.1)
